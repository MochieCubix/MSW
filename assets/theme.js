...
$(document).on('DOMSubtreeModified', ".product-form__cart-submit", function() {
  var attr = $('.product-action button').is(":disabled")
  $('.atc-duplicate-btn .btn').attr('disabled' , attr)
});
...
$(document).ready(function() {
  ...
  $('.atc-duplicate-btn .btn').click(function() {
  ...
  singleWidget.onUploadComplete(function(info) {
    ...
    $('#uploadcare_widget').attr('empty', 'false')
    cartTerm()
  });
  }
})
